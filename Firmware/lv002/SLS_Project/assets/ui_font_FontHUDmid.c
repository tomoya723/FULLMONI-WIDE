 ...
 * Size: 18 px
 * Bpp: 1
 * Opts: --bpp 1 --size 18 --font C:/Users/chake/OneDrive/Desktop/fullmoni_LVGL/assets/x14y24pxHeadUpDaisy.ttf -o C:/Users/chake/OneDrive/Desktop/fullmoni_LVGL/assets\ui_font_FontHUDmid.c --format lvgl -r 0x20-0x7f --no-compress --no-prefilter
 ******************************************************************************/

#include "../ui.h"

#ifndef UI_FONT_FONTHUDMID
#define UI_FONT_FONTHUDMID 1
#endif

#if UI_FONT_FONTHUDMID
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t ui_font_FontHUDmid = {
#else
lv_font_t ui_font_FontHUDmid = {
#endif
