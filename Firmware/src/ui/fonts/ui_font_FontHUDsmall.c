 ...
 * Size: 12 px
 * Bpp: 1
 * Opts: --bpp 1 --size 12 --font C:/Users/chake/OneDrive/Desktop/fullmoni_LVGL/assets/x8y12pxDenkiChip.ttf -o C:/Users/chake/OneDrive/Desktop/fullmoni_LVGL/assets\ui_font_FontHUDsmall.c --format lvgl -r 0x20-0x7f --no-compress --no-prefilter
 ******************************************************************************/

#include "../ui.h"

#ifndef UI_FONT_FONTHUDSMALL
#define UI_FONT_FONTHUDSMALL 1
#endif

#if UI_FONT_FONTHUDSMALL
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t ui_font_FontHUDsmall = {
#else
lv_font_t ui_font_FontHUDsmall = {
#endif
