...
//	R_Systeminit();
	...
	// S12AD ch0 : Battery Voltage
	//       ch2 : Fuel Level
	//       ch4 : Luminance for Auto Dimmer

	// RTC Start
/*	R_Config_RTC_Stop();
	RTC.RYRCNT.WORD = 0x0024U;
	RTC.RMONCNT.BYTE = 0x10U;
	RTC.RDAYCNT.BYTE = 0x05U;
	RTC.RHRCNT.BYTE = 0x23U;
	RTC.RMINCNT.BYTE = 0x32U;
...
//	wr_cnt = 0;
//	sp_int = 461496308; // データ入力用 181121km
//	tr_int = 461357187;	// データ入力用 181066km
